...
export const getIdeas = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to fetch ideas");
  }
};
...
export const createIdea = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to create idea");
  }
};
...
export const updateIdea = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to update idea");
  }
};
...
export const deleteIdea = async (req: Request, res: Response<BaseResponse>) => {
  try {
    ...
    console.error(error);
    serverError(res, "Failed to delete idea");
  }
};
...
export const pinIdea = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to update pin status");
  }
};
...
export const archiveIdea = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to update archive status");
  }
};
...
export const moveIdea = async (
  ...
  try {
    ...
    console.error(error);
    serverError(res, "Failed to move idea");
  }
};
