...
/**
 * Get activities data for a specific year
 */
...
/**
 * Get project statistics for a given time period
 */
...
/**
 * Get language statistics for a given time period
 */
...
/**
 * Get data for each day in the last 30 days
 */
...
/**
 * Get user minutes for a specified time period
 */
