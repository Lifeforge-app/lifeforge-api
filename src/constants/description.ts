const DESCRIPTION = {
  ...
  "PATCH /idea-box/idea/{id}": "Update an idea in an idea box container by ID",
  "DELETE /idea-box/idea/{id}": "Delete an idea in an idea box container by ID",
  ...
  "GET /notes/workspace/valid/{id}": "Validate a specific note workspace by ID",
