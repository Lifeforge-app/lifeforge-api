...
export const getReadmeImage = async (pb: PocketBase) => {
  ...
  <body class="flex p-4 text-zinc-100 flex-col w-full h-dvh border-lime-500 border-2 bg-zinc-900">
    <header class="border-b-2 border-zinc-800 p-2 w-full flex items-center justify-between">
      <div class="flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="text-lime-500">
      ...
      <div class="tracking-wider font-medium text-sm flex items-center gap-1">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" class="text-lime-500">
          <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <span>Lifeforge<span class="text-lime-500">.</span></span>
      </div>
    </header>
    <div class="flex-1 w-full space-y-2 mt-4">
      <div class="bg-lime-500 w-full p-2 flex items-center justify-between rounded-sm text-zinc-900">
      ...
      <div
        class="bg-zinc-800/50 border-lime-500 border-2 text-lime-500 w-full p-2 flex items-center justify-between rounded-sm">
        <div class="flex items-center gap-2 font-medium">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
